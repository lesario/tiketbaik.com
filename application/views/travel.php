            <script type="text/javascript">
                $(document).ready(function() {
                    document.getElementById("back_slider").className = "container-large_1";
                            ...
                            <div class="panel kotakdata" style="border-radius: inherit">
                                <div class="kotak_datatabel" data-toggle="collapse" data-parent="#accordion" data-target="#data<?php echo $i ?>">
                                    ...
                                    <div class="data_maskapai">
                                        <div><center><img src="<?php echo base_url() ?>assets/images/cipaganti.png"/></center></div>
                                    </div>
                                    ...
                                    <div class="data_maskapai2">
                                        <div><center><img src="<?php echo base_url() ?>assets/images/travelfacility.png"/></center></div>
                                    </div>
                                    <div class="data_maskapai2">
                                        <div>
                                            <h2>IDR 300.000,-</h2>
                                ...
                                <div id="data<?php echo $i ?>" class="collapse" >
                                  <div class="kotak_colaps">
                                      <div class="row detilpenerbangan_" >
                                          <div class="col-md-4">
                                              <center>
                                              <img src="<?php echo base_url() ?>assets/images/elf.png"/>
                                          ...
                                          <div class="col-md-6">
                                              <p>Kamis 15 Desember 2015 </p>
                                              <p>Fasilitas : AC, Wifi, Music, Makan 1x</p>
                                              <p>Berangkat : 08.30 WIB </p>
                                              <p>Estimasi : 3jam 20menit</p>
