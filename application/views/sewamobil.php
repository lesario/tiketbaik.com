           <script type="text/javascript">
                $(document).ready(function() {
                    document.getElementById("back_slider").className = "container-large_2";
            ...
            <div class="row">
                <div class="col-md-12 searchbox" >
                        ...
                        <ul class="nav nav-tabs nav_" >
                            ...
                            <li class="active"><a href="#sewamob" data-toggle="tab">SEWA MOBIL</a></li>
                        ...
                        <div class="tab-content tabcontent_">
                          ...
                          <div class="tab-pane active" id="sewamob">
                            <!---------------------MOBIL SEARCH TAB----------------------- -->
                            ...
                            <div class="panel kotakdata" style="border-radius: inherit">
                                <div class="kotak_datatabel" data-toggle="collapse" data-parent="#accordion" data-target="#data<?php echo $i ?>">
                                    ...
                                    <div class="data_maskapai">
                                        <div><center><img src="<?php echo base_url() ?>assets/images/trac.png"/></center></div>
                                    </div>
                                    <div class="data_maskapai2">
                                        <div>
                                            <img src="<?php echo base_url() ?>assets/images/avanza.png"/>
                                        </div>
                                    </div>
                                    <div class="data_maskapai2">
