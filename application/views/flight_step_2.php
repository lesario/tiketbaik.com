            ...
            <div class="row">
                <div class="col-md-12 content_">
                    ...
                    <div class="row">
                        <div class="col-md-4 remove padding" style ="background-color:#eee; margin-top:15px; width:320px">
                            ...
                            <div class="logo_lanjut" style="margin-bottom:15px">
                                <img src="<?php echo base_url()?>assets/images/lanjut_ke_pembayaran.png">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 remove padding" style ="background-color:#5a5a5a; margin-top:15px; color:#fff; width:320px">
                            <div class="logo_penting" style="padding-top:15px">
                                <img src="<?php echo base_url()?>assets/images/logo_info.png">
                            </div>
                    ...
                    <div class="row">
                     ...
                     <div class="row" style="">
                        <!-- Rincian Penerbangan-->
                        <div class="col-md-8" style="padding-left:30px; margin-top:-585px; margin-left:325px;">
                            ...
                            <div class="box_rincian_penerbangan" style="background-color:#fff;border: 1px solid #ddd; border-left: 4px solid #00cd00; padding:20px">
                                ...
                                <div class="rincian_penerbangan_1">
                                    <div class="logo_jangkauan">
                                        <img src="<?php echo base_url()?>assets/images/gambar_jangkauan.png">
                                    </div>
                                                ...
                                                <tr>
                                                    <td class="box_logo_penerbangan_asal">
                                                        <div class="logo_penerbangan_asal">
                                                            <img src="<?php echo base_url()?>assets/images/citilink_logo.png">
                                                        </div>
                                                    </td>
                                        ...
                                        <table class="baris_rincian_penerbangan_2">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="box_logo_penerbangan_asal">
                                                        <div class="logo_penerbangan_asal">
                                                            <img src="<?php echo base_url()?>assets/images/lion_logo.png">
                                                        </div>
                                                    </td>
                        ...
                        <!-- Rincian Harga Total -->
                        <div class="col-md-4 remove_padding"  style="background-color:#eee; margin-top: -75px; margin-left: 355px; width:300px">
                            ...
                            <div class="daftar_harga_total" style="width:45%;margin-top:-176px;margin-left:55%; padding-right:10px ">
                                <div class="harga_1_a">
                        ...
                        <div class="col-md-4 remove_padding" style="float:right; width:250px; margin-top:-75px">
